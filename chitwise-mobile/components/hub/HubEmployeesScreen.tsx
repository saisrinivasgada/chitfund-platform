...
export default function HubEmployeesScreen() {
  ...
  return <SafeAreaView style={{ flex: 1, backgroundColor: C.gray50 }}>
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 14, backgroundColor: C.surface, borderBottomWidth: 1, borderBottomColor: C.gray100 }}>
    ...
    <ScrollView contentContainerStyle={{ padding: 14 }}>
      {query.isLoading ? <ActivityIndicator color={C.navy} /> : employees.map(employee => <View key={employee.id} style={{ backgroundColor: C.surface, borderRadius: 14, padding: 14, marginBottom: 9, borderWidth: 1, borderColor: C.gray100 }}>
