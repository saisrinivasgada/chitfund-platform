        ...
        for (int attempt = 1; attempt <= MAX_ATTEMPTS; attempt++) {
            try {
                ...
                if (attempt < MAX_ATTEMPTS) {
                    ...
                    // All retries exhausted — log ERROR so alerting fires.
                    // The financial operation succeeded; this record must be recovered manually
                    // from the service log using entityType/entityId/action printed here.
