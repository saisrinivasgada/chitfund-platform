...
const RECORD_STATUS = {
  ...
  CREDIT_COVERED:    { bg: 'bg-emerald-100', text: 'text-emerald-700', label: 'Credit Covered' },
  PARTIAL_CREDIT:    { bg: 'bg-cyan-100',    text: 'text-cyan-700',    label: 'Partial Credit' },
};
...
function generatePrintHTML({ items, member, totalOwed, totalRefunded, grandTotal, tenantName = '', adjustmentAmount = 0, adjustmentReason = '' }) {
  ...
  const recLabel = { SETTLED: 'Settled', OUTSTANDING: 'Outstanding', PARTIALLY_PAID: 'Partial', PAYOUT_DEDUCTED: 'Payout Deducted', WAIVED: 'Waived', SETTLEMENT_CLEARED: 'Cleared', CREDIT_COVERED: 'Credit Covered', PARTIAL_CREDIT: 'Partial Credit' };
