...
export function Input({ className = '', iconLeft = null, ...props }) {
  if (iconLeft) {
    return (
      <div className="relative">
        <span className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400 flex items-center">
          {iconLeft}
        </span>
        <input
